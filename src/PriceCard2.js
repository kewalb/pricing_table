...
export function PriceCard2() {
  ...
  return (
      ...
      sx={{
        ...
        <CardHeader
          title={<Typography style={{ color: "grey" }}>Plus</Typography>}
          subheader={<Typography variant='h2'>$9<sub style={{ fontSize: 25 }}>/Month</sub></Typography>}
        ...
        <CardContent>
          <List style={{ margin: 0, padding: 1 }}>
            <ListItem>
              ...
              <ListItemText
                style={{ margin: 0 }}
                primary={<Typography><b>5 Users</b></Typography>} />
            </ListItem>
